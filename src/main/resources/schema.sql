 ...
 DROP TABLE IF EXISTS ADM_CLIENTE;
   CREATE TABLE ADM_CLIENTE
      (	NUM_LICENCIA NUMBER(10,0),
   	...
   	TIPO_CLIENTE CHAR(3 ),
   	SEC_PERSONA_TIPO_CLIENTE NUMBER(10,0),
   	FECHA_INGRESO DATE,
   	FECHA_SALIDA DATE,
 ...
 DROP TABLE IF EXISTS FD_NOTIFICACION_APORTE_BE;
  ...
  CREATE UNIQUE INDEX PK_FD_NOTIFICACION_APORTE_BE ON FD_NOTIFICACION_APORTE_BE (NUM_LICENCIA, COD_EMPRESA, COD_PRODUCTO, SEC_NOTIFICACION);